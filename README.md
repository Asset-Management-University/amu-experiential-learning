...
| `curricula/architects-journey.html` | The Architect's Journey — a curriculum for young people, carrying the Financial Freedom Builder and Business Builder streams (module pages in `curricula/architects-journey/`) |
| `gfmam/` | GFMAM Asset Management Landscape — 39 subject journey pages |
| `units/` | The Business Problem Library — every published unit, with an index |
